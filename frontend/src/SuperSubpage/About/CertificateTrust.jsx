...
function CertificateTrust() {
  const props1 = [
    <>
      <DataInMainComponant title="Trust Store Version " data="2023032800"   hr="yes"/>
      <DataInMainComponant title="Trust Asset Version" data="1002" />
    </>,
    <>
      <DataInMainComponant
        title="Apple Root Certificate Authority"  hr="yes"
        data={<ToogleSwitch label="AppleRoot" />}
      />
      <DataInMainComponant
        title="Apple Root CA - G3"   hr="yes"
        data={<ToogleSwitch label="G3" />}
      />
      <DataInMainComponant
        title="Apple Root CA - G2"  hr="yes"
